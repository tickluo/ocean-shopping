  ...
  <div>
    <div v-if="!$loadingRouteData">
      ...
      <footer class="shopping_footer">
        ...
        <a class="into_cart_btn" @click="addToCart()"> <img class="icon_into_shopping_cart"
                                                            :src="images.IconShoppingCart_2"/> <span
          class="dis_inline_block">放入购物车</span> </a>
      </footer>
    </div>
  </div>
</template>
...
<script>
  ...
  export default{
    ...
    computed: {
      ...
      OriginalCurrency () {
        return getCurrency(this.OriginalCurrencyCode)
      },
      Currency () {
        ...
        return this.getShopping(key)
          ...
          .then(data => {
            ...
            return this.initShoppingDisplay({
              ...
              rate: this.OriginalCurrencyCode,
              count: 1
            })
          })
      },
